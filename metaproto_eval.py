...
from data_more import MNIST, MiniImageNet, Fashion_MNIST, CIFAR, TaskSampler
...
if '__main__' == __name__:
    ...
    parser.add_argument('--weights', type=str, default='PM-apha1e-4-step5-teststep5/max_acc.pth')
